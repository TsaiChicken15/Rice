...
import rice.ui.clickgui.simple.button.*;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public void dispatchKeypresses()
    {
        ...
        {
        	if (this.currentScreen instanceof rice.ui.clickgui.simple.ClickGui) {
                ...
                if (Keyboard.getEventKey() == 14)
                	for (ArrayList<rice.ui.clickgui.simple.button.ModuleButton> mbList : Client.ClickGui.modules) {
                		for (rice.ui.clickgui.simple.button.ModuleButton m : mbList) {
                			if (m.listening) {
